...
# COMMAND:
# python xml2coco.py --dataset_type voc  --voc_anno_dir D:\Treat_for_data\Data\Annotations --voc_anno_list val.txt --voc_label_list label_list.txt  --voc_out_name coco_val.json
